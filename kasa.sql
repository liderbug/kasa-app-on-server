...
CREATE TABLE `fake` (
  ...
  `cmd` char(32) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6257 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
-- Dump completed on 2025-01-29  6:53:14
